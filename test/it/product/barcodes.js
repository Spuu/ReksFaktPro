...
module.exports = function (done) {
    ...
    var datasets = [
        {
            cash_register_name: 'Prod 2 barcode',
            ean: '1232222222123',
            name: 'Produkt drugi barcode',
            pih_amount: 222,
            pih_unit: 'g',
            vat: 8
        }
    ...
    var url = '/product/' + TestManager.getId('product_Prod_2') + '/barcodes/add/';
    ...
    Rx.Observable.zip(dataObs, resObs, data_res).subscribe(
        function (obj) {
            ...
            res.body._father._id.should.equal(TestManager.getId('product_Prod_2'));
